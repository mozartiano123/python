...
def reset_pomodoro():
    ...
    timer_label.config(text="TIMER", fg=GREEN, bg=YELLOW,highlightthickness=0, font=(FONT_NAME,50))
...
check_label = Label(fg=GREEN, bg=YELLOW,highlightthickness=0,font=(FONT_NAME,20))
